 ...
 * trajectory (catalog present: no anchor reproduced; see the sibling
 * repository for the methodology). We remove the catalog injection entirely
 * and expose two small tools instead — the Claude tool-search pattern:
 *
